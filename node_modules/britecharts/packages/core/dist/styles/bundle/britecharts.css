...
.line-chart .x-axis-group path,
.line-chart .y-axis-group path {
  display: none; }
...
.scatter-plot .y-axis-group line {
  display: none; }

.scatter-plot .y-axis-group path {
  display: none; }
...
.brush-chart .missing-brush-area {
  fill: #f8f8fa; }

.brush-chart .brush-rect.selection {
  fill-opacity: "8%";
  stroke-linejoin: round; }

.brush-chart .brush-rect.handle {
  fill: #00d8d2;
  width: 0.2rem; }

.brush-chart .x-axis-group path,
.brush-chart .y-axis-group path {
  display: none; }
