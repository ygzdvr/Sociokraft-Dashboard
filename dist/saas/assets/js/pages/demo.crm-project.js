! function(e) {
    ...
    t.prototype.init = function() {
        ...
        var t = ["#727cf5", "#0acf97"],
            ...
            r = {
                ...
                colors: t = (o = e("#monthly-target").data("colors")) ? o.split(",") : t,
                responsive: [{
                    breakpoint: 480,
                    options: {
                        chart: {
    ...
    }, e.CrmProject = new t, e.CrmProject.Constructor = t
}(window.jQuery),
function(o) {
    "use strict";
...
var colors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"],
    ...
    options = {
        ...
        series: [85, 70, 80, 55],
        labels: ["TikTok Campaigns", "Instagram Campaigns", "Youtube Campaigns", "Twitter Campaigns"],
        plotOptions: {
            radialBar: {
                track: {
                    margin: 5
